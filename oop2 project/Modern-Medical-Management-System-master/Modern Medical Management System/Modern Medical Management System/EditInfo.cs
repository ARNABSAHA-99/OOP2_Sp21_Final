...
namespace Modern_Medical_Management_System
{
    public partial class EditInfo : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e) //Update the Info
        {
            ...
            {
                errMsg += "\nSearch Any UserId which is available";
            }
            else
            {
                searhBox = tbSearch.Text;
            }
            ...
            {
                editEmail = tbUpdateEmail.Text;
            }

          
            if (tbUpdateMobileNo.Text.Equals(""))
            {
                errMsg += "\nUpdate Mobile No If needed";
            }
            else
            {
                editMobileNo = tbUpdateMobileNo.Text;
            }

            if (tbUpdateShift.Text.Equals(""))
            {
                errMsg += "\nUpdate Shift If needed";
            }
            else
            {
                editShift = tbUpdateShift.Text;
            }

          
            if (tbUpdateAddress.Text.Equals(""))
            {
                errMsg += "\nUpdate Address If needed";
            }
            else
            {
                editAddress = tbUpdateAddress.Text;
            }

           
            if (tbUpdateCategory.Text.Equals(""))
            {
                errMsg += "\nUpdate Category If needed";
            }
            else
            {
                editCategory = tbUpdateCategory.Text;
            }

          
            if (tbUpdateGender.Text.Equals(""))
            {
                errMsg += "\nUpdate Gender If needed";
            }
            else
            {
                editGender = tbUpdateGender.Text;
            }
